...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="max-width:740px; margin:0 auto; background:#efefef; min-height:500px;">
        <div style="height:80px; width:100%; background:#C22B2B; font-family:黑体; font-size:28px; line-height:80px; font-weight:bold; border-bottom:2px solid #73556F;">
            <div style="float:left; width:70px; height:70px; margin:6px 0 0 20px; background:url(<%=UserHeadImg %>) no-repeat; background-size:70px 70px;"><img src="images/headbg.png" width="70px" /></div>
            <div style="float:left; margin-left:10px;"><%=NickName %></div>
            <div style="float:right; margin-right:30px;">积分：<span style="color:#D69100"><%=user.Integral %></span></div>
        </div>
