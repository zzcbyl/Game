<%@ Page Title="恭喜你获得书城代金券。" Language="C#" MasterPageFile="~/7080/Master7080.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="width: auto; text-align: center;  ">
        ...
        <p style="text-align:center; font-size:16px; font-weight:bold; color:red; ">
            恭喜你获得了<span style="font-weight:bold; font-size:24px; padding:0 5px;"><asp:Literal ID="lbl_amount" runat="server"></asp:Literal>元</span>书城代金券。
        </p>
        <p>
        ...
        <div style="text-align:left; line-height:22px;">
            <div>1．该券只能在悦长大专家问答平台订阅号书城中使用。</div>
            <div>2．每单只能使用一张。</div>
        </div>
