...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="gameResult" style="position:fixed; top:0px; left:0px; width:100%; height:10000px; background:#FFEA01; z-index:9; display:none; ">
        <div style="width:auto; text-align:center; padding-top:0px; position:relative;">
            ...
            <div style="margin-top:15px;"><a href="javascript:void(0);" onclick="shareBtn();"><img src="../images/sharefriend.jpg" /></a></div>
            <div style="margin-top:15px;"><a id="retryA" style="display:block; cursor:pointer;"><img src="../images/retry.jpg" /></a></div>
        </div>
