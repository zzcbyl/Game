...
<head runat="server">
    ...
    <title>领取悦长大家庭教育专家问答平台阅读卡</title>
    <style type="text/css">
...
<body>
    <div style="width: auto; text-align: center;  ">
        ...
        <p style="text-align:center; font-size:16px; font-weight:bold; color:red; ">
            恭喜你获得了<span style="font-weight:bold; font-size:24px; padding:0 5px;"><asp:Literal ID="lbl_amount" runat="server"></asp:Literal>元</span>悦长大家庭教育专家问答平台书城读书卡。
        </p>
        <p>
        ...
        <div style="text-align:left; line-height:22px;">
            <div>1．该读书卡只能在悦长大家庭教育专家问答平台订阅号书城中使用。</div>
            <div>2．每单只能使用一张。</div>
        </div>
