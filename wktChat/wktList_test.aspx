...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .text-li { position:relative; min-height:50px;}
        ...
        .text-li .right-content .text-nick { line-height:22px; }
        .text-li .right-content .text-content { width:80%; background:#fff; border-radius:5px; padding:10px; line-height:22px; margin-top:5px;}
        .text-li .right-content .text-content_radio { line-height:22px; margin-top:5px;}

        .text-li-right { position:relative; min-height:50px;}
        ...
        .text-li-right .right-content .text-content { width:80%; background:#B4EB7C; border-radius:5px; padding:10px; line-height:22px; float:right;}
    </style>
</head>
        ...
        <div>
            <ul class="feed_file_list">
                <li>
                    <div class="text-li">
                        <div class="left-head">
                            <img src="images/cang.jpg" />
                        </div>
                        <div class="right-content">
                            <div class="text-nick"">苍老师</div>
                            <div class="text-content">啊岁的法撒旦啊岁的法撒旦分啊撒旦发射点发岁的啊岁的法撒旦分啊岁的法撒旦</div>
                ...
                <li>
                    <div class="text-li-right">
                        ...
                        <div class="right-content">
                            <div class="text-content">啊岁的法撒旦啊岁的法撒旦分啊撒旦发射点发岁的啊岁的法撒旦分啊岁的法撒旦</div>
                            <div style="position:absolute; right:65px; top:8px;"><img src="images/jt_icon_right.png" /></div>
                        </div>
                        <div class="clear"></div>
                    </div>
                </li>
